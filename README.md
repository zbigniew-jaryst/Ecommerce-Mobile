...
## 📖 Dla dewelopera (po polsku)

Jeśli dopiero zaczynasz pracę z tym projektem, przeczytaj **[PROJEKT.md](./PROJEKT.md)** — prosty przewodnik po architekturze, strukturze katalogów i kluczowych rzeczach, które warto wiedzieć przed pierwszą zmianą w kodzie.
